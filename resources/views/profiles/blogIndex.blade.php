...
<div class="col-12">
    <h3 style="text-align:center;font-weight:700">Manage Blog</h3>
<a href="{{ route('profile.indexForum',[$user->id]) }}"  class="btn btn-success mb-3" style="width:19%">Consultant</a>
<a  href="{{ route('profile.indexCourse',[$user->id]) }}"  class="btn btn-primary mb-3" style="width:19%">My Course</a>
...
<a href="{{route('post.create')}}" class="btn btn-primary mb-2" style="margin-left: 88%;">Write New Blog</a>
@endcan 
</div>
<div class="row">  
