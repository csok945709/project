...
<div class="container">
    <div class="row">
        <div class="col-8 offset-2">
            <form action="/consultant/addAppointmentTime/store" enctype="multipart/form-data" method="POST">
            @csrf
                <div class="row">
                    <h1>Manage Appointment Time</h1>
                </div>
                <div class="form-group row">
                    <label for="name" class="col-md-4 col-form-label">Consultant Name</label>                 
                        <input id="name" 
                               type="text" 
