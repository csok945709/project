...
<div class="container">
    <div class="row">
        <div class="col-8 offset-2">
            <form action="/p/reportStore/{{$post->id}}" enctype="multipart/form-data" method="POST">
            @csrf
            <h1 style="text-align:center;font-weight:600">Report Post<span style="color:red"> "{{ $post->caption }}" </span> </h1>
